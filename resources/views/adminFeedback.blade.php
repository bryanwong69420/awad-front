                        ...
                        <tbody>
                            @foreach ($feedbacks as $id => $feedback)
                                <tr>
                                    ...
                                    <td class="py-2 px-3">{{ $feedback->customer_name }}</td>
                                    ...
                                    <td class="py-2 px-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{ route('adminFeedbackView', ['id' => $feedback->id]) }}"
                                                class="text-primary me-4" title="View Feedback">
                                            ...
                                            <form action="{{ route('admin.feedback.delete', $feedback->id) }}" method="POST"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-link text-danger p-0 ms-4"
